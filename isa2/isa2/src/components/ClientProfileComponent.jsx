    ...
    render() {
        return (
            <div>
                ...
                <div className='container-xxl' style={{ width:'1200px', height:'650px', position:'absolute',left:'160px'}}>
                <text style={{ position: 'absolute', fontSize:'45px', top: '25px', left: '42%' }}> My profile </text>
                    ...
                    <div style={{position:'absolute',top:'144px',left:'700px'}}>
