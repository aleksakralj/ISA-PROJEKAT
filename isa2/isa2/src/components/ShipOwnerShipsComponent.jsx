...
class ShipOwnerShipsComponent extends Component {
    ...
    viewShip(id){
        axios
        .get("http://localhost:8080/api/v1/ships/" + id )
        .then(response => {
    ...
    deleteShip(id){
        axios.delete("http://localhost:8080/api/v1/ships/" + id);
    ...
    componentDidMount(){
        ...
        axios.get("http://localhost:8080/api/v1/ships/owner/" + activeUser.id).then((res)=>{
