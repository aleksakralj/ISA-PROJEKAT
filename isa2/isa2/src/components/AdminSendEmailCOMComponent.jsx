            ...
            <form onSubmit={sendEmail}>
                    <div className="row pt-5 mx-auto">
                        ...
                        <div className="col-8 form-group pt-2 mx-auto">
                            <input type="email" className="form-control" placeholder="Email Address" name="email" value={JSON.parse(localStorage.getItem('activeComplaint')).userEmail}/>
                        </div>
                        <div className="col-8 form-group pt-2 mx-auto">
                            <input type="email" className="form-control" placeholder="Email Address" name="email2" value={JSON.parse(localStorage.getItem('activeComplait')).onWhoEmail}/>
                        </div>
