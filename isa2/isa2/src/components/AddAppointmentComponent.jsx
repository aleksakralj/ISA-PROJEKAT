...
class AddAppointmentComponent extends Component {
    ...
    DateTimeIsEmpty(appointment){
        ...
        if(appointment.startingDate < today){return false}
            ...
            if (appointment.startingDate > appointment.endingDate) {return false}
                ...
                for(let i = 0; i < this.state.allFreeAppointments.length; i++) {    //prolaz kroz sve iz baze
        ...
        //proveriti i za zakazane termine u buducnosti
    ...
    else{window.alert("Invalid Date")}
    }
