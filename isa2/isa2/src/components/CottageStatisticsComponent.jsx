...
class CottageStatisticsComponent extends Component {
    ...
    componentDidMount(){
        ...
        axios.get("http://localhost:8080/api/v1/cottagehistoryappointments/cottage/" + activeCottage.id).then((res)=>{
            this.setState({appointments: res.data});
        }) ;

        
            axios.get("http://localhost:8080/api/v1/grades/typeandid/cottage/"+activeCottage.id).then((res2)=>{
